...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "twitter:description", content: "Create, sign and settle international trade contracts in Pi. Direct Pi Wallet connection and user-to-app payments." },
      { property: "og:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/09bd1210-efdd-4921-8e98-57446bef1861" },
      { name: "twitter:image", content: "https://storage.googleapis.com/gpt-engineer-file-uploads/attachments/og-images/09bd1210-efdd-4921-8e98-57446bef1861" },
    ],
    links: [
